...
class Transfer(models.Model):
    ...
    additional_error_info = models.TextField(null=True, blank=True)
    process_status = models.PositiveSmallIntegerField(choices=processing_statuses, default=TRANSFER_COMPLETED)
    archivesspace_identifier = models.CharField(max_length=191, null=True, blank=True)
    archivesspace_parent_identifier = models.CharField(max_length=191, null=True, blank=True)
    created_time = models.DateTimeField(auto_now_add=True)
    modified_time = models.DateTimeField(auto_now=True)
...
class BagInfoMetadata(models.Model):
    ...
    record_type = models.CharField(max_length=191)
    ...
    bag_group_identifier = models.CharField(max_length=191)
